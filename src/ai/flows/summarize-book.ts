...
مهمتك هي اختيار كتاب مشهور ومؤثر بشكل عشوائي من أي مجال معرفي (مثل التاريخ، السير الذاتية، العلم، الفلسفة، الأدب العالمي، أو تطوير الذات) وتقديم ملخص مفصل وممل له.

**قاعدة مهمة جداً: يُمنع منعاً باتاً اختيار أو تلخيص القرآن الكريم.**
